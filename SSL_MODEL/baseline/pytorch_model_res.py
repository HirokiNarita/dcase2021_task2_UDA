...
class ResNet22(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        ...
        self.CenterLoss = CenterLoss(classes_num, 2048)
    ...
    def forward(self, input, section_label, mixup_lambda=None):
        """
        ...
        center_loss, pred = self.CenterLoss(embedding, section_label)
        #output_dict = {'clipwise_output': clipwise_output, 'embedding': embedding}

        return center_loss, pred
