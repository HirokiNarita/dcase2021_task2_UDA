...
class EfficientNet_b1(nn.Module):
    def __init__(self, n_out=36, n_centers=6):
        ...
        self.fc0 = nn.Linear(1280+n_centers, 1280, bias=False)
    ...
    def forward(self, x, section_label):
        ...
        section_onehot = F.one_hot(section_label, num_classes=6)
        cl_feat = torch.cat([embedding, section_onehot], dim=1)
        centerloss_out = self.fc1(self.swish(self.bn0(self.fc0(cl_feat))))
