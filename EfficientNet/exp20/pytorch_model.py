...
class EfficientNet_b1(nn.Module):
    def __init__(self, n_out=36, n_centers=6):
        ...
        self.fc_centerloss = nn.Linear(1280, 1280)
        self.bn_centerloss = nn.BatchNorm1d(1280)
        #　最終層の再定義
    ...
    def forward(self, x, section_label):
        ...
        centerloss_out = self.fc_centerloss(embedding)
        centerloss_out = self.bn_centerloss(centerloss_out)
